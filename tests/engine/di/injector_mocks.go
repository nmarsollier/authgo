...
import (
	...
	db "github.com/nmarsollier/authgo/engine/db"
	log "github.com/nmarsollier/authgo/engine/log"
	rabbit "github.com/nmarsollier/authgo/rabbit"
	token "github.com/nmarsollier/authgo/token"
...
func (m *MockInjector) RabbitChannel() rabbit.RabbitChannel {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RabbitChannel")
	ret0, _ := ret[0].(rabbit.RabbitChannel)
	return ret0
}
...
func (m *MockInjector) TokenCollection() db.MongoCollection {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TokenCollection")
	ret0, _ := ret[0].(db.MongoCollection)
	return ret0
}
...
func (m *MockInjector) UserCollection() db.MongoCollection {
	m.ctrl.T.Helper()
