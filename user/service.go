...
func NewUserService(log log.LogRusEntry, userRepository UserRepository) UserService {
	return &userService{
		log:        log,
...
func (s *userService) ChangePassword(userID string, current string, newPassword string) (err error) {
...
func (s *userService) Disable(userID string) (err error) {
